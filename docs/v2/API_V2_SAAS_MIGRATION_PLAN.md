...
Criar uma nova camada backend (NestJS + Prisma) para evolução SaaS multi-tenant
sem alterar o fluxo atual em produção.
...
Estratégia expand/backfill/contract para evitar indisponibilidade durante a
migração.
...
Referência para refactor de interface: `docs/v2/LAYOUT_V2_COMPATIBILIDADE.md`.

Checklist operacional pós-refactor visual: `docs/v2/MIGRACAO_API_V2_CHECKLIST.md`.
